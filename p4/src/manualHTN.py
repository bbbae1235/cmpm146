...
# pyhop.pyhop(state, [('have_enough', 'agent', 'plank', 12)], verbose=3)
# pyhop.pyhop(state, [('have_enough', 'agent', 'stick', 4)], verbose=3)
# pyhop.pyhop(state, [('have_enough', 'agent', 'bench', 1)], verbose=3)
