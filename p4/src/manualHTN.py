...
pyhop.declare_operators (op_punch_for_wood, op_craft_wooden_axe_at_bench, op_craft_wooden_pickaxe_at_bench, 
						 op_wooden_axe_for_wood, op_craft_plank, op_craft_stick, op_craft_bench)
